      ...
      <body className="bg-background ">
        <div className="mx-auto">
          <Head>
            ...
            <meta
              property="og:title"
              content="Vrijstaande woning te Deventer"
            />
            <meta
              property="og:image"
              content="/images/projecten/featured/featured-image-bloemsma.jpg"
            />
            <meta
              property="og:description"
              content="Deze vrijstaande woning staat op nieuwbouwplan Spijkvoorderhout te Deventer. De woning komt helemaal tot zijn recht op deze riante kavel."
            />
