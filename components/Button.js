  ...
  return (
    ...
    >
      <a className="flex flex-row items-center" href={props.href}>
        ...
        {icon && (
          <svg
            className="fill-current text-heading ml-2"
            width="16"
            height="16"
            viewBox="0 0 16 16"
            fill="none"
