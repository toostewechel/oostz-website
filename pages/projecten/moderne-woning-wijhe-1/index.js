      ...
      <body className="bg-background ">
        <div className="mx-auto">
          <Head>
            ...
            <meta
              property="og:image"
              content="/images/projecten/featured/featured-image-plattenberg.jpg"
            />
            <meta
          ...
          <main>
            ...
            <section>
              <LandingImage
                backgroundImage="/images/projecten/plattenberg/landing-image-plattenberg.jpg"
                category="Woningbouw"
            ...
            >
              <Layout>
                ...
                <div className="flex mb-16 md:mb-32">
                  <ProjectImage
                    src="/images/projecten/plattenberg/plattenberg-rectangle-1.jpg"
                ...
                <div className="flex">
                  <ProjectImage
                    src="/images/projecten/plattenberg/plattenberg-rectangle-2.jpg"
